 ...
 * @author Usuario
 */
public class ReporteProductosVentasSucursal extends javax.swing.JInternalFrame {

     VentaDAO v = new VentaDAO();
    DefaultTableModel model = new DefaultTableModel();
    
    public ReporteProductosVentasSucursal() {
        initComponents();
        listar();
    }

    void listar() {
        List<Venta> lista = v.ProductoVentaSucursal();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre Producto", "Sucursal", "Total Ventas"
            }
        ));
